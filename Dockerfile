...
RUN (New-Object System.Net.WebClient).DownloadFile('http://docker-lab:8081/artifactory/windows-server-local/test/vc_redist.x64.exe', 'c:/Users/ContainerAdministrator/Downloads/vc_redist.x64.exe') \
    ...
    Start-Process 'c:/Users/ContainerAdministrator/Downloads/vc_redist.x64.exe' '/install /passive /norestart' -Wait; \
    Remove-Item c:/Users/ContainerAdministrator/Downloads/vc_redist.x64.exe;
